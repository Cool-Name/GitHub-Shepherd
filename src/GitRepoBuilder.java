...
public class GitRepoBuilder {
	...
	/*
	 *  Idealy this should only be run once, then the user can
	 *  decide to re-use if they want to do a system wide update
	 *  This basically searches for all repos under directory and
	 *  builds different representations.
	 *  
	 */
	...
	/*
	 * Write repo locations to a text file
	 * so that we can load in later for speed
	 * 
	...
	/*
	 * Read in a text cache of repository
	 * locations
	 * 
